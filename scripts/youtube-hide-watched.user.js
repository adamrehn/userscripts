	...
	function performSetup()
	{
		...
		function updateVisibility()
		{
			...
			if (toggleHideOld.is(':checked'))
			{
				...
				let old = findAncestors($("ytd-rich-item-renderer yt-lockup-metadata-view-model yt-content-metadata-view-model .ytContentMetadataViewModelMetadataRow:last-child span:last-child").filter(function(index, element)
				{
